//Send message when temperature is too low
...
function Read_Lowest_temperature(callback) {
    ...
    ddb.getItem(params_Lowest_temperature, function (err, data, response) {
        if (err) {
            ...
            var Lowest_temperature = JSON.parse(Jsondata).Item.val.N;
...
function Read_Highest_temperature(callback) {
    ...
    ddb.getItem(params_Highest_temperature, function (err, data, response) {
        if (err) {
            ...
            var Jsondata = JSON.stringify(data, null, 2);
            var Highest_temperature = JSON.parse(Jsondata).Item.val.N;
...
function Read_IOT_Data(event, YMD, HMS, callback) {
    ...
    var Temperature_outside =10;// JSON.parse(datapackage).reported.to;
    var Humidmity = 10;//JSON.parse(datapackage).reported.h;
    var Light_level =10;// JSON.parse(datapackage).reported.l;
    var Soil_Moisture_1 =10;// JSON.parse(datapackage).reported.a;
    var Soil_Moisture_2 = 10;//JSON.parse(datapackage).reported.b;
    var Soil_Moisture_3 = 10;//JSON.parse(datapackage).reported.c;
